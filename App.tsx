...
const STORAGE_KEY = 'brain_test_lite_final';
  ...
  if (view === 'SPLASH') {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-blue-600 text-white p-10 text-center">
        ...
        <p className="text-blue-200 text-[10px] font-black uppercase tracking-[0.5em] mb-16 opacity-80">PROD-LITE v1.0</p>
      ...
      <div className="flex flex-col min-h-screen bg-[#FDFDFF] animate-in slide-in-from-bottom duration-500">
        <div className="p-6 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <p className="font-black text-gray-800">Hi, {gameState.user?.name}</p>
          </div>
          <button 
           ...
           <div className="w-full max-w-xs space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                 ...
                 >
                  ...
                  <span className="text-[10px] font-black text-gray-400 uppercase">Setup</span>
                 </button>
              </div>
           </div>
        </div>
        ...
        <div className="bg-white p-10 rounded-[3rem] shadow-xl border border-gray-100 mb-8 flex flex-col items-center text-center">
            {currentQ.imageUrl && (
              <div className="mb-8 w-full h-64 rounded-3xl overflow-hidden bg-gray-50 ring-4 ring-blue-50">
                <img src={currentQ.imageUrl} className="w-full h-full object-cover" alt="Brain puzzle illustration" />
              </div>
            )}
